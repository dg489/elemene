				...
				<div class="food-content">
					...
					<div class="content">
						...
						<div class="cartcontrol-warpper">
							<cartcontrol :food='food' @cardadd ='addFood'></cartcontrol>
						</div>
					...
					<div class="rating">
						...
						<ratingselect :desc='desc' :select-type='selectType' :only-content='onlyContent' :ratings='food.ratings' @selected='selectRating' @selectedcount='selectcount'></ratingselect>
	...
	export default{
		...
		methods: {
			show() {
				...
				this.$nextTick(() => {
					if (!this.scroll) {
						this.scroll = new BetScroll(this.$refs.food, {
							click: true
						})
					} else {
						this.scroll.refresh()
